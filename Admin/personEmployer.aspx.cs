...
public partial class admin_personEmployer : System.Web.UI.Page
{
    ...
    {
        this._message.Text = "Person Employer was Updated";
    }

    protected void _RowDeleted(object sender, GridViewDeletedEventArgs e)
    {
        this._message.Text = "Person Employer was Deleted";
    }
    ...
    protected void _addNew_Click(object sender, EventArgs e)
    {
        ...
        this._personEmployer.Visible = false;
        this._message.Text = "";
        this._personID.SelectedValue = "0";
        this._employerID.SelectedValue = "0";
    }
    ...
    protected void _clear_Click(object sender, EventArgs e)
    {
        ...
        this._personEmployer.Visible = true;
    }
    ...
    protected void _submit_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("[personEmployerInsert]", conn))
            {
                ...
                cmd.Parameters.AddWithValue("@employerID", this._employerID.Text);
                ...
                try
                {
                    ...
                    if (intResponse == 0)
                    {
                        this._message.Text = "Person Employer already existed - Not Added";
                    }
                    else
                    {
                        this._message.Text = "Person Employer was Added";
                    }

                    // Following line refreshes your grid for the new record
                    this._personEmployer.DataBind();
                }

                // If there are any errors with the store procedure, display them in the message label
                catch (SqlException ex)
                {
                    this._message.Text = "Error on inserting into the personEmployer Table " + ex.Message;
                }
            }
        }
